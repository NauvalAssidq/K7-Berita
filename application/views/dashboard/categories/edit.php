...
<head>
    ...
    <title>Sunting Kategori - <?php echo CMS_NAME; ?></title>
    ...
    <main id="mainContent" style="width: calc(100% - 4.5rem); margin-left: 4.5rem;" class="transition-all duration-300">
        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Sunting Kategori</h1>
                    <p class="mt-1 text-sm text-gray-600">Perbarui kategori konten yang sudah ada</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <form action="<?php echo site_url('categories/edit/' . $category->id); ?>" method="POST" class="p-6 space-y-6">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Kategori</label>
                        <input type="text" id="name" name="name" value="<?php echo set_value('name', $category->name); ?>" 
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="slug" value="<?php echo set_value('slug', $category->slug); ?>" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
